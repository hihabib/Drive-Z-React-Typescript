  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className={`d-flex gap-3 align-items-center ${classes.fileNameWithIcon}`}
          >
            <BiSolidFile />
            <CardHeader className={classes.fileTitle}>
              {isRenameActive ? (
                <>
          ...
          <div
            className={`d-flex justify-content-center align-items-center ${classes.moreIcon}`}
